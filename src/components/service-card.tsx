...
export const ServiceCard = ({ service: { id, name, description, price }, isSelected, onToggle }: ServiceCardProps) => {
    ...
    return (
        ...
        <div className={`grid grid-cols-1 gap-2 border rounded-lg p-4 shadow-xl lg:grid-cols-3 lg:items-center lg:p-7 ${isSelected ? 'bg-amber-50 border-amber-300 shadow-amber-700/30' : 'bg-amber-50/30 border-stone-300'}`}>
